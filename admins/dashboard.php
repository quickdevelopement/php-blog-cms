...
<script>
    document.title = "Dashboard || Blog CMS";
</script>
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="flex flex-col items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
                ...
                <h2 class="text-4xl font-semibold text-gray-900 dark:text-white"><?= $result->num_rows; ?></h2>
            </div>
            <div class="flex flex-col items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
                <h4 class="text-md text-bold text-gray-900 dark:text-gray-100">
                    Total Admin
                </h4>
                <h2 class="text-4xl font-semibold text-gray-900 dark:text-white"><?= $admin->num_rows; ?></h2>
        ...
        <div class="w-full overflow-x-auto shadow-md sm:rounded-lg">
                <?php if ($result->num_rows > 0) { ?>
                    ...
                    <?php } else { ?>
                    <p class="text-center text-2xl text-gray-900 dark:text-gray-500 py-5">Sorry!No Post Found</p>
                <?php } ?>
            </div>
        </div>
